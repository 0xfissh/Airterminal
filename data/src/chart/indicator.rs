...
impl KlineIndicator {
    const SPOT: [KlineIndicator; 2] = [KlineIndicator::Volume, KlineIndicator::CVD];
    const PERPS: [KlineIndicator; 3] = [KlineIndicator::Volume, KlineIndicator::OpenInterest, KlineIndicator::CVD];
}
