...
pub struct Config {
    ...
    pub show_usd_values: bool,
    #[serde(default)]
    pub hover_tooltip_settings_open: bool,
    pub trade_opacity: f32,
}
...
impl Default for Config {
    fn default() -> Self {
        Config {
            ...
            hover_tooltip_settings_open: false,
            trade_opacity: 0.6,
        }
    }
}
...
pub struct GroupedTrade {
    ...
    pub price: f32,
    pub qty: f32,
    // Hyperliquid-specific transaction metadata (not used for other exchanges)
