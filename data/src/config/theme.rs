...
pub fn redshift_theme() -> Custom {
    Custom::new(
        "Redshift".to_string(),
        Palette {
            background: Color::from_rgb8(12, 12, 12), // #0C0C0C
            text: Color::from_rgb8(222, 222, 222),    // #DEDEDE
            primary: Color::from_rgb8(200, 200, 200), // Keep default primary
            success: Color::from_rgb8(238, 238, 238), // #EEEEEE
            danger: Color::from_rgb8(255, 21, 21),    // #FF1515
            warning: Color::from_rgb8(238, 216, 139), // Keep default warning
        },
    )
}
...
impl Serialize for Theme {
        ...
        S: serde::Serializer,
    {
        if let iced_core::Theme::Custom(custom) = &self.0 {
            let theme_name = custom.to_string();
            let ser_theme = SerTheme {
                name: match theme_name.as_str() {
                    "Airterminal" => "airterminal".to_string(),
                    "Redshift" => "redshift".to_string(),
                    _ => "custom".to_string(),
                },
                palette: match theme_name.as_str() {
                    "Airterminal" | "Redshift" => None,
                    _ => Some(self.0.palette()),
                },
            };
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        if let Some(s) = value.as_str() {
            let theme = match s {
                ...
                "airterminal" => iced_core::Theme::Custom(default_theme().into()),
                "redshift" => iced_core::Theme::Custom(redshift_theme().into()),
