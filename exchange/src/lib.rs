...
pub struct Trade {
    ...
    pub price: f32,
    pub qty: f32,
    // Hyperliquid-specific transaction metadata (optional for other exchanges)
    pub transaction_hash: Option<String>,
    pub users: Option<[String; 2]>, // [buyer, seller]
}

impl Trade {
    /// Creates a Trade without Hyperliquid-specific metadata
    pub fn new(time: u64, is_sell: bool, price: f32, qty: f32) -> Self {
        Trade {
            time,
            is_sell,
            price,
...
impl TickMultiplier {
    pub const ALL: [TickMultiplier; 10] = [
        TickMultiplier(1),
        TickMultiplier(2),
        TickMultiplier(5),
        TickMultiplier(10),
